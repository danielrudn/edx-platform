...
from lms.djangoapps.saved_courses.message_types import SaveForLater
...
class SaveForLaterApiView(APIView):
    ...
    def post(self, request):
        ...
        message_context = {
            ...
            'partner_image_url': course_org['logo'].url,
            ...
            'mobile_store_urls': get_config_value_from_site_or_settings('MOBILE_STORE_URLS'),
        }
        ...
        try:
            ...
            segment.track(
                user.id,
                'edx.bi.user.sent.email.save.for.latter',
