...
class UserTour(models.Model):
    ...
    .. no_pii:
    """
    class CourseHomeTourStatusChoices(models.TextChoices):
    ...
    course_home_tour_status = models.CharField(
        max_length=50, choices=CourseHomeTourStatusChoices.choices, default=CourseHomeTourStatusChoices.NEW_USER_TOUR
    )
